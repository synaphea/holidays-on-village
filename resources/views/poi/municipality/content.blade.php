<div id="wrapper">
    ...
    <div id="content" class="mob-max">
        ...
        <div class="amenities" ng-controller="FoursquareController" data-ng-init="retrieve('{{ $municipality['normal_name']}}')">
            <h3>FOURSQUARE</h3>
            <div class="row">
        ...
        @include('vendor.widget.results', ['base' => 'village', 'paginate' => false, 'title' => 'ΔΗΜΟΤΙΚΕΣ ΕΝΟΤΗΤΕΣ'])
        <div class="clearfix"></div>
    </div>
</div>
