<div id="wrapper">
    ...
    <div id="content" class="mob-max">
        ...
        <div class="description" ng-controller="WikipediaController" data-ng-init="retrieve('{{ $county['capital_city'] }}')">
            <h3>ΠΛΗΡΟΦΟΡΙΕΣ</h3>
            <p>[[| introduction |]]</p>
        </div>
        <div class="share">
        ...
        <div class="amenities" ng-controller="FoursquareController" data-ng-init="retrieve('{{ $county['capital_city'] }}')">
            <h3>FOURSQUARE</h3>
            <div class="row">
